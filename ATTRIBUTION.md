...
|---|---|---|
| [addyosmani/web-quality-skills](https://github.com/addyosmani/web-quality-skills) | Addy Osmani (Google) | MIT |
| [addyosmani/agent-skills](https://github.com/addyosmani/agent-skills) | Addy Osmani (Google) | MIT |
...
| [emalorenzo/three-agent-skills](https://github.com/emalorenzo/three-agent-skills) | Ema Lorenzo (emalorenzo) | MIT per README — NO root LICENSE file detected (unconfirmed) |
| [emilkowalski/skills](https://github.com/emilkowalski/skills) | Emil Kowalski | MIT |
| [expo/skills](https://github.com/expo/skills) | Expo / 650 Industries | MIT |
| [flutter/agent-plugins](https://github.com/flutter/agent-plugins) | Flutter team (official) | BSD-3-Clause |
| [multica-ai/andrej-karpathy-skills](https://github.com/multica-ai/andrej-karpathy-skills) | Forrest Chang / Multica (packaging Andrej Karpathy's coding-pitfalls notes) | MIT asserted (frontmatter/README/plugin.json) — NO LICENSE file (unconfirmed) |
| [gamedev-skills/awesome-gamedev-agent-skills](https://github.com/gamedev-skills/awesome-gamedev-agent-skills) | gamedev-skills | Apache-2.0 |
...
| [Yakoub-ai/phaser4-gamedev](https://github.com/Yakoub-ai/phaser4-gamedev) | Yakoub-ai | MIT per README — NO root LICENSE file detected (unconfirmed) |

## Redistribution notes

- Skills retain their original licenses — see each skill's `SOURCE.md` and the upstream repo's `LICENSE`.
- Sources flagged `NO-LICENSE`, `LICENSE-UNCONFIRMED`, or `LICENSE-INCONSISTENT` in `scripts/sources.txt` must be resolved before any public redistribution of their content.
- The recommended way to share this publicly is as a **curation layer** (gitignore `skills/`; users run `scripts/bootstrap.sh` to pull each skill from its upstream) — this avoids redistributing others' work entirely.
